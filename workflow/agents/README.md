...
| `car_approach_agent.py` | `CarApproachAgent`: Commander wrapper that runs `python -m agents.car_approach.subprocess_entry` as a subprocess. | `car_approach_node` | ROS2, PyBullet/OMPL, `src/` |
