...
| `car_approach_agent.py` | Commander wrapper。real mode 以 subprocess 執行 `agents.car_approach.subprocess_entry`。 | `car_approach_node` | ROS2、PyBullet/OMPL、`src/` |
| `car_approach/` | 底盤靠近與手臂/夾爪收尾 runtime。 | `car_approach_agent.py` | ROS2 action/topic、`src/` |
