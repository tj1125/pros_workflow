...
if not _DISABLE_VIS:
    ...
    def _no_vis(*_args, **_kwargs):  # pragma: no cover - guard for headless runs
        raise RuntimeError("Visualization is disabled (GRASPGEN_NO_VIS=1)")

    create_visualizer = _no_vis
    make_frame = _no_vis
    visualize_grasp = _no_vis
    visualize_mesh = _no_vis
    visualize_pointcloud = _no_vis
