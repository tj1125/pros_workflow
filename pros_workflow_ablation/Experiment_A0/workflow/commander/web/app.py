...
async def _stream_graph(
    ...
    try:
        ...
        # Flush any in-progress Experiment_A0 report (idempotent; no-ops if the
        # task already finalized on goodbye_node or never reached item-info).
        session.store.finalize_experiment()
