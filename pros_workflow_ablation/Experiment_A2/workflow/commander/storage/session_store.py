...
class SessionMemoryStore:
    ...
    def __init__(
        ...
        *,
        ...
        # Experiment A2 execution recorder. Each pick task
        ...
        # (env EXPERIMENT_A2_RESULT_DIR overrides it), so no output_dir is forced.
    ...
    def record_event(self, *, step: int, node_name: str, state_update: Dict[str, Any]) -> None:
        ...
        # Feed the merged state to the A2 experiment recorder (raw update carries
