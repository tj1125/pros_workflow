...
def compute_offset(obj_pts, ee_pose, rot, grid_res=0, cam_pose=None):
    ...
    obj_pts_stable = obj_pts - ee_pose[:3, 3]
    # NOTE: Temporarily disable rotating object points around the gripper frame.
    # obj_pts_stable = obj_pts_stable @ rot.transpose(-1, -2)
    if grid_res > 0:
