...
async def _stream_graph(
    ...
    # Ablation A3 execution recorder: records this stream from
    # get_item_info_no_sam3d_node to the end of the pick workflow. Chat-only
    # turns never reach that node, so report.write() is a no-op for them.
    ...
    try:
        ...
        if report.started:
            ...
            if report_path:
                logger.info("[web_server] Experiment A3 report written: %s", report_path)
