...
try:
    ...
    def _format_checkpoint(checkpoint):
        return checkpoint

    def _load_distributed_checkpoint(_path):
        raise RuntimeError(
            "Sharded checkpoint loading requires lightning.pytorch; install lightning/setuptools."
        )
...
def load_model_from_checkpoint(
    ...
    if _HAS_LIGHTNING and isinstance(model, pl.LightningModule):
